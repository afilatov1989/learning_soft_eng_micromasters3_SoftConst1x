...
public class GymChainInfo {
    ...
    public static final String YOUR_GYM_NAME = "Filatov's Gym";
    public static final String YOUR_MEMBER_NAME = "Alexey";
