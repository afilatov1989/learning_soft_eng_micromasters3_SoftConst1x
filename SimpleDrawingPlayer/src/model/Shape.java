...
abstract public class Shape {
    ...
    // REQUIRES: playLineCoord should be between 0 and width
    // EFFECTS:  draws the playing line within the Shape in its current position
    abstract protected void drawPlayLine(Graphics g, Color save);
    ...
    abstract protected void drawGraphics(Graphics g);

    //EFFECTS: fills the shape
    abstract protected void fillGraphics(Graphics g);
